...
> [!IMPORTANT]
> **Beta testing v2.1.0-beta.3.** The current stable release on crates.io is v2.0.0; v2.1.0 is in beta testing. Running `cargo install trim-galore` without `--version` installs v2.0.0 (the stable). To install the beta:
>
> ```bash
